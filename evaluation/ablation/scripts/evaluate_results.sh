#sh evaluate_results.sh ../promptsOutput/java ../TestResults/java java
#sh evaluate_results.sh ../promptsOutput/python ../TestResults/python python
...
do
    ...
    if [ -d "$folder" ] && [ "$folder" != "." ] && [ "$folder" != ".." ] ; then
        ...
        # 执行Python脚本
        echo "python evaluate_results.py $1/$foldername $2/$foldername $3"
        python evaluate_results.py $1/$foldername $2/$foldername $3
